...
const testUpdateSubcategory = async () => {
  ...
  const result = await apiCall('PUT', `/admin/subcategory/${global.createdSubcategoryId}`, updateData, adminToken);
...
const testDeleteSubcategory = async () => {
  ...
  const result = await apiCall('DELETE', `/admin/subcategory/${global.createdSubcategoryId}`, null, adminToken);
